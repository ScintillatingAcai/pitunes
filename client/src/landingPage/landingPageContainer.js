                        ...
                        <div className="col-lg-12">
                            <div className="intro-message">
                                ...
                                <ul className="list-inline intro-social-buttons">
                                    <li>
                                        <a onClick={this.loginClick} className="btn btn-default btn-lg" id="landing-signin"><i className="fa fa-sign-in fa-fw"></i><span className="network-name">Sign In</span></a>
                                    </li>
                                    <li>
                                        <a href="#/rooms" className="btn btn-default btn-lg" id="landing-join"><i className="fa fa-music fa-fw"></i><span className="network-name">Join Room</span></a>
                                    </li>
                                    <li>
                                        <a onClick={this.signupClick} className="btn btn-default btn-lg" id="landing-signup"><i className="fa fa-pencil fa-fw"></i><span className="network-name">Sign Up</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
